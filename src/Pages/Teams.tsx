...
const Teams = () => {
    ...
    return (
        ...
        >
            {/* Add member form  */}
            <form onSubmit={submitHandler} className='w-[80vw] bg-[#99B3FE] mt-16 p-3 rounded-3xl md:flex justify-between'>
                <div className='md:w-[25%] w-full flex flex-col'>
                    <label htmlFor="name">Name</label>
                    <input type="text" name='name' placeholder='Enter Team Member Name' className='p-2 rounded-xl' required onChange={changeHandler} value={data.name}
                    />
                </div>
                <div className='md:w-[25%] w-full flex flex-col '>
                ...
                <div className='mt-6 flex justify-center'>
                    <button type='submit' className='p-2 bg-white md:w-[110px]  rounded-xl'>Add Member</button>
                </div>
            </form>
